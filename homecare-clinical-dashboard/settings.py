"""
Django settings for homecare-clinical-dashboard project.
...
ROOT_URLCONF = 'homecare-clinical-dashboard.urls'
...
WSGI_APPLICATION = 'homecare-clinical-dashboard.wsgi.application'
